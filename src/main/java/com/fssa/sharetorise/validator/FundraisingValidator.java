...
public class FundraisingValidator {
	...
	public boolean validateFundingRaiser(FundingRaiser fund) throws FundraiserDataException {
	 ...
	 *                                 2000.
	 */
	public boolean validateFundingGoal(double fundingGoal) throws FundraiserDataException {
	 ...
	 *                                 the current date.
	 */
	public boolean validateFundEndingDate(LocalDate fundEndingDate) throws FundraiserDataException {
