...
public class UserService {
	...
	public boolean createFundraiser(FundingRaiser fundraiser) throws SQLException {
	...
	public boolean updateFundraiser(FundingRaiser fundraiser) throws SQLException {
